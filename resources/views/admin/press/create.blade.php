    ...
    <div class="card-body">
        <form action="{{ route("admin.press.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <input type="text" id="headline" name="headline" class="form-control" required value="{{ old('headline', isset($product) ? $product->headline : '') }}">
                @if($errors->has('title'))
            ...
            {{--<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">--}}
                ...
                {{--<input type="text" rows="1" id="written_by" name="written_by" class="form-control" required value="{{ old('written_by', isset($product) ? $product->name : '') }}"></input>--}}
