    ...
    <div class="card-body">
        <form action="{{ route("admin.patients.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <select  id="gender" name="gender" class="form-control select2" value="{{ old('gender', isset($patients) ? $patients->gender : '') }}">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <input type="date" id="dob" name="dob" class="form-control" value="{{ old('dob', isset($patients) ? $patients->dob : '') }}">
                @if($errors->has('title'))
                    <em class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </em>
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <textarea type="text" id="street_address" name="street_address" class="form-control" value="{{ old('street_address', isset($patients) ? $patients->street_address : '') }}"></textarea>
