...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route("admin.doctors.update",[$doctors]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                {{--<input type="text" id="picture" name="picture" class="form-control"  value="{{ old('picture', isset($doctors) ? $doctors->name : '') }}">--}}
                {{--@if($errors->has('title'))--}}
                {{--<em class="invalid-feedback">--}}
                {{--{{ $errors->first('title') }}--}}
                {{--</em>--}}
                ...
                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                    ...
                    <input type="number" id="phone_no" name="phone_no" class="form-control" value="{{ old('phone_no', isset($doctors) ? $doctors->phone_no : '') }}"></input>
